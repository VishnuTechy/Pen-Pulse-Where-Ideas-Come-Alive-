...
export async function GET(req) {
  ...
  return new Response(JSON.stringify({ posts, page, totalPages, total }), { status: 200 })
}
...
export async function POST(req) {
  ...
  if (!title || !content) return new Response(JSON.stringify({ message: 'Missing fields' }), { status: 400 })
